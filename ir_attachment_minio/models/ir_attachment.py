...
try:
    ...
    _logger.debug('boto3 or minio package is required which is not \
...
class IrAttachment(models.Model):
    ...
    def _get_s3_object_url(self, s3, s3_bucket_name, key_name):
        ...
        endpoint_url = self._get_s3_settings('endpoint.url', 'ENDPOINT_URL')
    ...
    def _get_s3_resource(self):
        ...
        if not bucket:
            ...
            s3.make_bucket(Bucket=bucket_name)
